...
public class FollowServiceTest {
    ...
    /**
     * Verify that for successful requests, the {@link FollowService#getMoreFollowing}
    ...
    /**
     * Verify that for successful requests, the the {@link FollowService#getMoreFollowing}
    ...
    /**
     * Verify that for unsuccessful requests, the the {@link FollowService#getMoreFollowing}
    ...
    public void testGetFollowees_invalidRequest_returnsNoFollowees() throws InterruptedException {
        followServiceSpy.getMoreFollowing(null, 0, null, observer);
        awaitCountDownLatch();
